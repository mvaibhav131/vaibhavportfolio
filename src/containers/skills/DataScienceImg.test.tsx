...
describe("DataScienceImg", () => {
  it("is a valid React component export", () => {
    expect(DataScienceImg).toBeDefined();
    expect(typeof DataScienceImg === "function" || typeof DataScienceImg === "object")
      .toBe(true);
  });
  ...
  it("renders without crashing (with required providers)", () => {
    ...
    try {
      renderWithProviders(<DataScienceImg theme={mockTheme} />);
    } catch (e) {
