...
describe("FullStackImg", () => {
  it("is a valid React component export", () => {
    expect(FullStackImg).toBeDefined();
    expect(typeof FullStackImg === "function" || typeof FullStackImg === "object")
      .toBe(true);
  });
  ...
  it("renders without crashing (with required providers)", () => {
    ...
    try {
      renderWithProviders(<FullStackImg theme={mockTheme} />);
    } catch (e) {
