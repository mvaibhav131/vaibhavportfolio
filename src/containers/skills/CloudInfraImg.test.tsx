...
describe("CloudInfraImg", () => {
  it("is a valid React component export", () => {
    expect(CloudInfraImg).toBeDefined();
    expect(typeof CloudInfraImg === "function" || typeof CloudInfraImg === "object")
      .toBe(true);
  });
  ...
  it("renders without crashing (with required providers)", () => {
    ...
    try {
      renderWithProviders(<CloudInfraImg theme={mockTheme} />);
    } catch (e) {
