...
describe("ExperienceAccordion", () => {
  it("is a valid React component export", () => {
    expect(ExperienceAccordion).toBeDefined();
    expect(typeof ExperienceAccordion === "function" || typeof ExperienceAccordion === "object")
      .toBe(true);
  });
  ...
  it("renders without crashing (with required providers)", () => {
    ...
    try {
      renderWithProviders(<ExperienceAccordion sections={[]} theme={mockTheme} />);
    } catch (e) {
