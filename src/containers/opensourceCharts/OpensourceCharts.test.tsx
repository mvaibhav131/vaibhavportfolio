...
describe("OpensourceCharts", () => {
  it("is a valid React component export", () => {
    expect(OpensourceCharts).toBeDefined();
    expect(typeof OpensourceCharts === "function" || typeof OpensourceCharts === "object")
      .toBe(true);
  });
  ...
  it("renders without crashing (with required providers)", () => {
    ...
    try {
      renderWithProviders(<OpensourceCharts theme={mockTheme} />);
    } catch (e) {
