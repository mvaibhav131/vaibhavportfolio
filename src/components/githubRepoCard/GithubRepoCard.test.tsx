...
describe("GithubRepoCard", () => {
  it("is a valid React component export", () => {
    expect(GithubRepoCard).toBeDefined();
    expect(typeof GithubRepoCard === "function" || typeof GithubRepoCard === "object")
      .toBe(true);
  });
  ...
  it("renders without crashing (with required providers)", () => {
    ...
    try {
      renderWithProviders(<GithubRepoCard repo={{}} theme={mockTheme} />);
    } catch (e) {
