...
describe("PullRequestChart", () => {
  it("is a valid React component export", () => {
    expect(PullRequestChart).toBeDefined();
    expect(typeof PullRequestChart === "function" || typeof PullRequestChart === "object")
      .toBe(true);
  });
  ...
  it("renders without crashing (with required providers)", () => {
    ...
    try {
      renderWithProviders(<PullRequestChart />);
    } catch (e) {
