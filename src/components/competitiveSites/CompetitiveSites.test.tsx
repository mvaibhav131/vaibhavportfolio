...
describe("CompetitiveSites", () => {
  it("is a valid React component export", () => {
    expect(CompetitiveSites).toBeDefined();
    expect(typeof CompetitiveSites === "function" || typeof CompetitiveSites === "object")
      .toBe(true);
  });
  ...
  it("renders without crashing (with required providers)", () => {
    ...
    try {
      renderWithProviders(<CompetitiveSites logos={[]} />);
    } catch (e) {
