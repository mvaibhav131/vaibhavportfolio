...
describe("EducationImg", () => {
  it("is a valid React component export", () => {
    expect(EducationImg).toBeDefined();
    expect(typeof EducationImg === "function" || typeof EducationImg === "object")
      .toBe(true);
  });
  ...
  it("renders without crashing (with required providers)", () => {
    ...
    try {
      renderWithProviders(<EducationImg theme={mockTheme} />);
    } catch (e) {
