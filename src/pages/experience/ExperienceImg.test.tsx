...
describe("ExperienceImg", () => {
  it("is a valid React component export", () => {
    expect(ExperienceImg).toBeDefined();
    expect(typeof ExperienceImg === "function" || typeof ExperienceImg === "object")
      .toBe(true);
  });
  ...
  it("renders without crashing (with required providers)", () => {
    ...
    try {
      renderWithProviders(<ExperienceImg theme={mockTheme} />);
    } catch (e) {
